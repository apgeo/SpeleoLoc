...
import 'package:speleoloc/widgets/filterable_list/filterable_list_widgets.dart';
        ...
        children: [
          ...
          if (widget.sortFields.isNotEmpty)
            ValueListenableBuilder<FilterableListSortSpec?>(
              ...
              builder: (context, spec, _) => ActiveIconButton(
                active: spec != null,
          ...
          if (widget.enableFilter)
            ValueListenableBuilder<bool>(
              valueListenable: _filterVisible,
              builder: (context, visible, _) => ActiveIconButton(
                active: visible,
                activeColor: theme.activeToggleColor,
