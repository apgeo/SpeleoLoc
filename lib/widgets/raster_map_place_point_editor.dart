...
// Re-export the sort options + trip overlay data (extracted to
// widgets/raster_map/) so existing callers importing them from this file
...
// Re-export the controller + host interface (extracted to widgets/raster_map/)
// so existing callers importing them from this file keep working.
export 'package:speleoloc/widgets/raster_map/raster_map_place_point_editor_controller.dart';
