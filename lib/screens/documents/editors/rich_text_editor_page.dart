...
class _RichTextEditorPageState extends ConsumerState<RichTextEditorPage>
  ...
  List<TourStepDef> get tourSteps => [
    TourStepDef(
      keyId: 'title_field',
      titleLocKey: 'tour_rich_text_editor_title_field_title',
      bodyLocKey: 'tour_rich_text_editor_title_field_body',
    ),
    TourStepDef(
      keyId: 'quill',
      titleLocKey: 'tour_rich_text_editor_quill_title',
      bodyLocKey: 'tour_rich_text_editor_quill_body',
    ),
    TourStepDef(
      keyId: 'menu',
      titleLocKey: 'tour_rich_text_editor_menu_title',
      bodyLocKey: 'tour_rich_text_editor_menu_body',
    ),
  ];
