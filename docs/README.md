...
Welcome to the user documentation for **SpeleoLoc**, a mobile application for cavers
that helps with:

- **Underground positioning** — knowing where you are on a cave map by
  scanning QR codes physically placed at points of interest.
...
[feature reference](features/) if you are looking up a specific function.
...
- [Navigating underground with QR codes](workflows/navigating-underground.md)
